...
- [ ] [70 — Off-main-thread serialize (Web Worker)](70-worker-serialize.md) — 🟢🟢 run Lute `VditorIRDOM2Md` in a Worker → no freeze + animated spinner; spike first (does lute.min.js run in a Worker?).
